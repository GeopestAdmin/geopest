      ...
      <div class="home-inner">
        <div class="p-2 w-full grid gap-8 grid-cols-1 md:grid-cols-2 mx-auto bg-white text-gray-900 rounded-lg md:p-4">
          <div class="flex flex-col">
            <div>
              ...
              <div class="text-gray-700 mt-8">
                Hate forms? Send us an <span class="underline"><a href="mailto:admin@geopest.co.za">email</a></span> instead.
                <ul>
                  <li>Tel: 021 532 9226</li>
                  <li>Cell: 078 735 2341</li>
                  <li>Email: info@geopest.co.za</li>
                </ul>
              </div>
            </div>
          ...
          <form class="" @submit="onSubmit">
            <div v-if="isSending" class="loading animate-pulse">{{statusMsg}}</div>
            <div>
            ...
            <div class="mt-8">
              ...
              <textarea
                class="w-full h-32 bg-gray-300 text-gray-900 mt-2 p-3 rounded-lg focus:outline-none focus:shadow-outline resize-none" 
...
export default {
  ...
  methods: {
    ...
    onSubmit(e) {
      ...
      try {
        emailjs.send('service_g2jdpge', 'template_c5ccbt5', {
          user_name: this.contact.name,
          reply_to: this.contact.email,
          message: this.contact.message,
          contact_number: '000'
        }, 'user_bGNNsyvvyOqDbYblku70v');

        setTimeout(() => { this.statusMsg = "Sent!" }, 3000);
      } catch (err) {
        console.log(err);
      }
